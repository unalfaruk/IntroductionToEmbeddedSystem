...
/**
* @brief Set zeros on a pointer
*
* take a pointer to a source memory location, a length in bytes and
* set all locations of that memory to zero input.
*
* @param src Pointer to source
* @param size Length of bytes to set
*
...
/**
* @brief Reverse data in a pointer, and write
*
* Take a pointer to a memory memory location and a length in bytes and
* reverse the order of all of the bytes.
*
* @param src Pointer to source
* @param size Length of bytes to reverse
*
* @return pointer.
*/
...
*
* @param size Length of bytes to allocate
*
* @return pointer.
*/
...
*
* @param size Pointer to a word allocated
*
* @return Nothing.
*/
